...
public final class DbHelper extends SQLiteOpenHelper {
  ...
  public void onCreate(SQLiteDatabase db) {
    ...
    // |(primary) | (string)  |  (string)  | (string)  |(string) | (string)  | (1 to 60) | (boolean) | (0 to 100) | (0 to 100) | (0 to 60) |
    // |   id     | media_url | media_name |media_type |tone_url | tone_name |   snooze  |  vibrate  |  vol_start |  vol_end   | vol_time  |
